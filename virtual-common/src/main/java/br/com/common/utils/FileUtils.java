...
abstract class FileUtils {
    ...
    public final static int escrever(Path path, InputStream stream, long tamanho, long capacidade)
    ...
    public final static InputStream particionar(FileChannel channel, long position, long byteSize)
            throws CommonException {
        try {
