...
public class SwaggerUIResource {
    ...
    public String documentacao(@Context Request request) {
        ...
        final String url = String.format("%s://%s", request.getProperties().get("PROTOCOL"),
                request.getProperties().get("listener.interface.id"));
        final String json = url + "/swagger?path=" + VolumeResource.RESOURCE_ROOT_URL;
        ...
        html.append("       <script src=\"").append(url).append(RESOURCE_ROOT_URL)
                .append("/resources/swagger-ui-bundle.js\"> </script>         ");
        html.append("       <script src=\"").append(url).append(RESOURCE_ROOT_URL)
                .append("/resources/swagger-ui-standalone-preset.js\"> </script> ");
        html.append(
                "       <script>                                                                                                            ");
        html.append(
    ...
    public Response resources(@PathParam("nome") String nome) {
        try {
            ...
            final StreamingOutput stream = fileLer(classLoader.getResource("swagger_ui/" + nome).openStream());
